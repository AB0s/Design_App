...
var exploreCourses = [
  Course(
    ...
    illustration: 'illustration-04.png', logo: '',
  ),
  Course(
    courseTitle: "Build an app with SwiftUI",
    courseSubtitle: "22 sections",
    ...
    illustration: 'illustration-05.png', logo: '',
  ),
];
...
var continueWatchingCourses = [
  ...
  Course(
    ...
    illustration: 'illustration-07.png', logo: '',
  ),
];
...
var courseSections = [
  Course(
    ...
    illustration: 'illustration-01.png', logo: '',
  ),
  Course(
    courseTitle: "Flutter for Designers",
    ...
    illustration: 'illustration-08.png', logo: '',
  ),
  Course(
    ...
    illustration: 'illustration-09.png', logo: '',
  ),
  Course(
    ...
    illustration: 'illustration-10.png', logo: '',
  ),
  Course(
    courseTitle: "React for Designers",
...
var completedCourses = [
  Course(
    ...
    illustration: 'illustration-12.png', logo: '',
  ),
  Course(
    ...
    illustration: 'illustration-13.png', logo: '',
  ),
];
